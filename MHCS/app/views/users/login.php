            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="<?php echo URLROOT; ?>/users/register" class="signup-image-link">Create an account</a><br><br>
                        <a href="<?php echo URLROOT; ?>/counsellors/counsellorLogin" class="signup-image-link">Sign in as a Counsellor</a>
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        <!-- The Actual Form -->
                        <form action="<?php echo URLROOT; ?>/users/login" method="POST" class="register-form" id="form">    <!--Here we are actua;;y sending the file to Users controller and login method to process-->
