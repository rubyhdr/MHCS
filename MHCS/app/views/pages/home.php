...
<div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
    ...
    <li class="nav-item">
      <a class="nav-link" href="journaling.php">Journaling</a>
    </li>
    <li class="nav-item">
...
<h2 class="checkin"><b> Consult with Our Counsellors <b/></h2>
  ...
  <br>
  <br>
  <a href="chat system/index.php" class="btn btn-primary btn-lg" style="background-color: #9389E1 !important; color: Black; text-align: center;"><b>Chat with your counsellor ></b></a>
  <br>
  <br>
  <br>
  <br>
