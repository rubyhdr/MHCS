  ...
  <head>
    ...
    <!-- Nav bar -->
      ...
      <!-- journaling box-->
       ...
       <form method="POST" action="<?php echo URLROOT; ?>/feeds/feedback">


      <div class="align">
  	  <b>Preferred name for feedback</b>
  		<input type="text" name="name"  class="form-control"/>

      <b>Subject of Comment</b>
      <input type="text" name="subject" placeholder="write your counsellor's name"  class="form-control"/>
			...
			<textarea class="form-control" name="feedback" placeholder="" id="floatingTextarea2" style="height: 50px" position="center"></textarea>
